...
var mobiles = {
  ...
  for (var brand in mobiles) {
    ...
    for (var model in mobiles[brand]) {
        ...
        let details = mobiles[brand][model];
        for (var property in details) {
            console.log("\t\t" + property + ":");
            if (typeof details[property] === "object") {
                let subDetails = details[property];
                for (var subProperty in subDetails) {
                    if (typeof subDetails[subProperty] === "object") {
                        console.log("\t\t\t" + subProperty + ":");
                        let subSubDetails = subDetails[subProperty];
                        for (var subSubProperty in subSubDetails) {
                            console.log("\t\t\t\t", subSubProperty + ":", subSubDetails[subSubProperty]);
                        }
                    } else {
                        console.log("\t\t\t", subProperty + ":", subDetails[subProperty]);
                    }
                }
            } else {
